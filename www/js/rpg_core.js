...
Input.update = function () {
	...
	//console.log('currentState' + this._latestButton)
...
Tilemap.prototype._createLayers = function () {
	//console.log("W:" + $gameMap.width());
	//console.log("H:" + $gameMap.height());
	...
	var tileCols = $gameMap.width() + 1;
	var tileRows = $gameMap.height() + 1;
...
Tilemap.prototype._drawNormalTile = function (bitmap, tileId, dx, dy) {
	...
	if (source) {
		bitmap.bltImage(source, sx, sy, w, h, dx, dy, w, h, tileId);
	}
};
